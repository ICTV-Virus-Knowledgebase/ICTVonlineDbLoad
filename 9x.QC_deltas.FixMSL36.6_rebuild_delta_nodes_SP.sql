...
/****** Object:  StoredProcedure [dbo].[rebuild_delta_nodes]    Script Date: 5/5/2021 6:14:31 PM ******/
SET ANSI_NULLS ON
GO
...
AS
	...
	insert into taxonomy_node_delta (prev_taxid, new_taxid, proposal, notes, is_new, is_split, is_now_type, is_promoted, is_demoted)
	select 
	...
	insert into taxonomy_node_delta (prev_taxid, new_taxid, proposal, notes, is_renamed, is_merged, is_moved, is_promoted, is_demoted, is_now_type, is_deleted)
