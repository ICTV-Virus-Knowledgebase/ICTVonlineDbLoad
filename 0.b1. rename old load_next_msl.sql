...
--
exec sp_rename 'DF_load_next_msl__msl_release_num', 'DF_load_next_msl__msl_release_num_35';  
GO

-- 
-- rename table
EXEC sp_rename 'load_next_msl', 'load_next_msl_35';  
...
SELECT name, SCHEMA_NAME(schema_id) AS schema_name, type_desc, type  
FROM sys.objects  
WHERE parent_object_id = (OBJECT_ID('load_next_msl_35'))   
AND type IN ('D','C','F', 'PK');   
GO 