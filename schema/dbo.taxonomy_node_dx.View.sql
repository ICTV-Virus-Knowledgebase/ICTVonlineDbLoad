USE [ICTVonlnie34]
GO
/****** Object:  View [dbo].[taxonomy_node_dx]    Script Date: 4/24/2020 3:40:38 PM ******/
SET ANSI_NULLS ON
GO
...
select 
	  prev_id = pd.prev_taxid, prev_ictv_id=pt.ictv_id, prev_tags = pd.tag_csv, prev_lineage=pt.lineage, prev_proposal=pd.proposal
	, next_id = nd.new_taxid,  next_ictv_id=nt.ictv_id, next_tags =nd.tag_csv, next_lineage=nt.lineage, next_proposal=nd.proposal
	, t.*
