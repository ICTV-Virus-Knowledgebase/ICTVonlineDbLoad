USE [ICTVonlnie34]
GO
/****** Object:  StoredProcedure [dbo].[taxonomy_node_compute_indexes_20150312]    Script Date: 4/24/2020 3:40:38 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[taxonomy_node_compute_indexes_20150312] 
	@taxnode_id int,
	@left_idx  int = 1,
...
AS	
	...
	*/
	...
	SELECT 
		...
		,@inher_molecule_id   = ISNULL(self.molecule_id,@inher_molecule_id)
