...
select report='history of F116', msl_release_num, in_change, in_target, in_filename, lineage
from taxonomy_node
...
select report='X: Cherry ras leaf virus'
	, target_taxnode_id, msl_release_num, taxnode_id, ictv_id, in_change, in_target, in_filename, out_change, out_target, out_filename, lineage
from taxonomy_node_x
