...
/****** Object:  StoredProcedure [dbo].[taxonomy_node_compute_indexes]    Script Date: 4/21/2020 9:33:33 PM ******/
SET ANSI_NULLS ON
GO
...
exec taxonomy_node_compute_indexes 201900000
...
select name, notes, order_desc_ct, family_desc_ct, subfamily_desc_ct, genus_desc_ct, species_desc_ct, tree_id
from taxonomy_node 
...
select * from taxonomy_node where is_hidden=1 order by tree_id, left_idx
